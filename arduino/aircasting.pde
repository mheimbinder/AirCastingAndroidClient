/*
  ...
  The sensor:model should be different for each sensor.
...
void loop()
{
  ...
  Serial.print(kelv);
  Serial.print(";CityTech56789;LM335A-K;Temperature;K;kelvin;K;255;269;283;297;310");
  Serial.print("\n");
  Serial.print(cel);
  Serial.print(";CityTech56789;LM335A-C;Temperature;C;degrees Celsius;C;0;10;20;30;40");
  Serial.print("\n");
  Serial.print(fah);
